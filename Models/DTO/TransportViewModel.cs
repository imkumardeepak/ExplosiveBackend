...
namespace Peso_Baseed_Barcode_Printing_System_API.Models.DTO
{
	public class TransportViewModel
	{
		...
		public List<TransportMemberViewModel> Members { get; set; } // List of members associated with the transport
		public List<TransportVehicleViewModel> Vehicles { get; set; } // List of vehicles associated with the transport

		public TransportViewModel()
		{
			Members = new List<TransportMemberViewModel>();
			Vehicles = new List<TransportVehicleViewModel>();
		}
	}

	public class TransportMemberViewModel
	{
	...
	public class TransportVehicleViewModel
	{
